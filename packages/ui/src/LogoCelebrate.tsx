 ...
 * `Logo`). Web serves `apps/web/public/logo-celebrate.png` (copy of
 * `packages/ui/src/logo-celebrate.png`) — see AGENTS.md Brand. Source art is
 * a PixelLab celebrate render with a black knockout background; the shipped
 * PNG must land with a transparent (not black) alpha, matching `Logo`.
 */
