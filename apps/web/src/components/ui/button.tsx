  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ui text-sm font-bold transition-[transform,box-shadow,background-color,color,filter] duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97] active:translate-y-px motion-reduce:transition-colors motion-reduce:active:scale-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "font-display border-2 border-[color-mix(in_srgb,var(--secondary)_32%,var(--border))] bg-[color-mix(in_srgb,var(--secondary)_26%,var(--card))] text-foreground shadow-[0_3px_0_0_color-mix(in_srgb,var(--secondary)_28%,#8a7040)] hover:bg-[color-mix(in_srgb,var(--secondary)_40%,var(--card))] hover:-translate-y-0.5 hover:shadow-[0_5px_0_0_color-mix(in_srgb,var(--secondary)_32%,#8a7040)] active:bg-[color-mix(in_srgb,var(--secondary)_34%,var(--card))] active:shadow-[0_1px_0_0_color-mix(in_srgb,var(--secondary)_28%,#8a7040)] dark:border-[color-mix(in_srgb,var(--secondary)_45%,var(--border))] dark:bg-[color-mix(in_srgb,var(--secondary)_40%,#fff)] dark:text-[#2c322e] dark:shadow-[0_3px_0_0_color-mix(in_srgb,var(--secondary)_42%,#2c322e)] dark:hover:bg-[color-mix(in_srgb,var(--secondary)_52%,#fff)] dark:hover:shadow-[0_5px_0_0_color-mix(in_srgb,var(--secondary)_38%,#2c322e)] dark:active:bg-[color-mix(in_srgb,var(--secondary)_46%,#fff)] dark:active:shadow-[0_1px_0_0_color-mix(in_srgb,var(--secondary)_42%,#2c322e)]",
        ghost:
