...
Root keeps sync `TooltipProvider` (IconTooltip requires it). **SFX engine** stays in Play/Options/sounds (not root). How-to SFX = dynamic import so Web Audio recipes stay off cold how-to.
